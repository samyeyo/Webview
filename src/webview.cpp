...
LUA_METHOD(Webview, add_virtualfolder) {
   	WebviewHandler *wv = static_cast<WebviewHandler*>(lua_self(L, 1, Widget)->user);
	int result = FALSE;
	if (wv->webview3) {
...
LUA_METHOD(Webview, remove_virtualfolder) {
   	WebviewHandler *wv = static_cast<WebviewHandler*>(lua_self(L, 1, Widget)->user);
	int result = FALSE;
	if (wv->webview3) {
		wchar_t *host = luaL_checkFilename(L, 2);
...
luaL_Reg Webview_methods[] = {
  {"eval", 	          Webview_evaljs},
  {"addinitscript",   Webview_addinitscript},
  {"reload",          Webview_reload},
  {"goback",          Webview_goback},
  {"goforward",       Webview_goforward},
  {"stop",            Webview_stop},
  {"opendevtools",    Webview_opendevtools},
  {"loadstring",      Webview_loadstring},
  {"hostfromfolder",  Webview_add_virtualfolder},
  {"restorehost",     Webview_remove_virtualfolder},
  {"postmessage",     Webview_postmessage},
  {"get_zoom",        Webview_getzoom},
  {"set_zoom",        Webview_setzoom},
  {"get_devtools",    Webview_getdevtools},
  {"set_devtools",    Webview_setdevtools},
  {"get_contextmenu", Webview_getcontextmenu},
  {"set_contextmenu", Webview_setcontextmenu},
  {"get_statusbar",   Webview_getstatusbar},
  {"set_statusbar",   Webview_setstatusbar},
  {"get_title",       Webview_gettitle},
  {"get_url",           Webview_geturl},
  {"set_url",           Webview_seturl},
  {"get_cangoback",     Webview_getcangoback},
  {"get_cangoforward",  Webview_getcangoforward},
	{NULL, NULL}
};
